        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            {loading ? (
              ...
              <p className="text-xs text-slate-500 text-center py-6">No historical snapshots saved yet.</p>
            ) : (
                      ...
                      <div className="p-3.5 bg-[#0D0F12]/95 border border-[#2A2F35] rounded-xl group-hover:border-slate-700/80 transition-all space-y-2">
                        ...
                        <div className="pt-2 flex items-center gap-2">
                          <button
                            ...
                            className="px-2.5 py-1 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded text-[10px] font-semibold transition-all"
                          >
                            Compare
                          </button>
                          <button
      ...
      {showRestoreConfirm && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full shadow-2xl space-y-6 text-center">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-100">Restore this snapshot?</h3>
